numbers = [4754, -4895, -364, -4764, 4683, 1639, -43, 228, -2701, -1503, 1223, 4340, -1296, 3939, -345, 623, -3275,
           ...
           2384, 4072, -90, 204, 1158, -3134, -2512, 756, 4148, 4370, 1756, 3609, -1148, -3909, 4123, -2906, 69, 96,
           1111]

print(sum(map(lambda a: a*a, filter(lambda a: len(str(abs(a))) == 2 and a % 9 == 0, numbers))))

# smart
# print(sum(map(lambda x: x ** 2 if -100 < x < 100 and not x % 9 else 0, numbers)))
